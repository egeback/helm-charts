...
![Version: 2.0.17](https://img.shields.io/badge/Version-2.0.17-informational?style=flat-square) ![AppVersion: 3.0.0](https://img.shields.io/badge/AppVersion-3.0.0-informational?style=flat-square)
...
| controllers.main.containers.teslamateagile.image.tag | string | `"v1.21.0"` |  |
...
| controllers.main.containers.teslamateapi.image.tag | string | `"1.24.2"` |  |
