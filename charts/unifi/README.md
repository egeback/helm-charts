...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![AppVersion: v7.3.83](https://img.shields.io/badge/AppVersion-v7.3.83-informational?style=flat-square)
...
helm repo update
helm install unifi egeback/unifi
```
...
```console
helm install unifi egeback/unifi -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/egeback/unifi?modal=changelog)
