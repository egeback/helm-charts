...
{{- $primaryPort := "" -}}
{{- if $primaryService -}}
  {{- $primaryPort = get $primaryService.ports (include "bjw-s.common.lib.service.primaryForController" (dict "serviceName" (include "bjw-s.common.lib.service.primaryForController" .) "values" $primaryService)) -}}
{{- end -}}
